...
def Verify(A, G, x1, x2):
    ...
    x1.shape = (-1,1)
    x2.shape = (-1,1)
    # print("input1", np.transpose(x1).shape)
    # print("input2", np.transpose(x2).shape)
    # print(A.shape)
    # print(G.shape)
    # print(np.dot(np.dot(np.transpose(x1),A),x1).shape)
    # print(np.dot(np.dot(np.transpose(x2),A),x2).shape)
    # print(np.dot(np.dot(np.transpose(x1),G),x2).shape)
